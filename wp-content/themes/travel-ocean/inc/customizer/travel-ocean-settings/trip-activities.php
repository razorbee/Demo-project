<?php
/**
 * This file has the settings for the trip activities section options.
 *
...
if ( ! function_exists( 'travel_ocean_customizer_settings_trip_activities' ) ) {

	/**
	 * Adds settings and options for the trip activities option.
	 *
	 * @param object $wp_customize WP customizer object.
	 */
	function travel_ocean_customizer_settings_trip_activities( $wp_customize ) {
	...
	add_action( 'customize_register', 'travel_ocean_customizer_settings_trip_activities' );
}
