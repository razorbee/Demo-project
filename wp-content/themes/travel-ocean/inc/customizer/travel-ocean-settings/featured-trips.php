...
if ( ! function_exists( 'travel_ocean_customizer_settings_featured_trips' ) ) {
	 ...
	 */
	function travel_ocean_customizer_settings_featured_trips( $wp_customize ) {
	...
	add_action( 'customize_register', 'travel_ocean_customizer_settings_featured_trips' );
}
